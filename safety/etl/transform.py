...
INSERT INTO silver.incident (
    ...
    occurred_basis, occurred_local_hour, reported_at, latitude, longitude, coordinate_source, geom,
    h3_r8, h3_r9, h3_r10, raw_offense_code, raw_offense_text, raw_source_category,
...
ON CONFLICT (source_id, occurred_year, incident_key) DO UPDATE SET
    ...
    occurred_local_hour = EXCLUDED.occurred_local_hour,
